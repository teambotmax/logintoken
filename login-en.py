...
wait = {
    ...
    'autoAdd':True,
    'autoJoin':True,
    'message':"Thanks For Add Me, Now You Can Invite Me To Your Group ☆",
    "lang":"JP",
    }
    ...
    try:
        ...
        if op.type == 5:
            ...
            if wait["autoAdd"] == True:
                ...
                print ("[ 5 ] Notify Add Friends: " + contact.displayName)
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
